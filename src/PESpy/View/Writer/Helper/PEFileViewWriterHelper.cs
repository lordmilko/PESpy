...
namespace PESpy.View
{
    class PEFileViewWriterHelper : IViewWriterHelper
    {
        ...
        public PEFileViewWriterHelper(PEFile peFile, ViewMode mode)
        {
            this.peFile = peFile;
            this.mode = mode;
            TryGetOffsetDelegate = GetViewOffsetResolver(peFile, mode);
            GetRealOffsetDelegate = GetRealOffsetResolver(peFile, mode);
        }

        private static ViewWriter.TryGetOffsetDelegate GetViewOffsetResolver(PEFile peFile, ViewMode mode)
        {
            switch (mode)
            {
