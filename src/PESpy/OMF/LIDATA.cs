...
{
    //A3 is 32-bit
    //https://www.azillionmonkeys.com/qed/Omfg.pdf p51

    /// <summary>
    /// Logical Iterated Data Record
    /// </summary>
    public readonly unsafe struct LIDATA : IViewable
    {
        ...
        IView? IViewable.WriteStruct(ViewWriter writer) =>
            writer.NewUnmanagedStruct(this, ViewKind.LIDATA, OMFRecord.GetStructSize(value));
