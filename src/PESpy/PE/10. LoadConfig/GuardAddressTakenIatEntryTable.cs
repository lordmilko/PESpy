...
namespace PESpy
{
    ...
    public readonly struct GuardAddressTakenIatEntryTable : IValue, IViewable, IEnumerable<GuardAddressTakenIatEntryTable.Entry>
    {
        ...
        IView? IViewable.WriteStruct(ViewWriter writer) =>
            writer.NewStruct(this, ViewKind.GuardAddressTakenIatEntryTable, StructSize);
        ...
        public readonly struct Entry : IValue, IViewable
        {
            ...
            IView? IViewable.WriteStruct(ViewWriter writer) =>
                writer.NewStruct(this, ViewKind.GuardAddressTakenIatEntryTable_Entry, sizeof(int) + (Flags != null ? 1 : 0));
