...
namespace PESpy
{
    ...
    public readonly struct GuardEHContinuationTable : IValue, IViewable, IEnumerable<GuardEHContinuationTable.Entry>
    {
        ...
        IView? IViewable.WriteStruct(ViewWriter writer) =>
            writer.NewStruct(this, ViewKind.GuardEHContinuationTable, StructSize);
        ...
        public readonly struct Entry : IValue, IViewable
        {
            ...
            IView? IViewable.WriteStruct(ViewWriter writer) =>
                writer.NewStruct(this, ViewKind.GuardEHContinuationTable_Entry, sizeof(int) + (Flags != null ? 1 : 0));
