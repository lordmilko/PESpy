...
namespace PESpy
{
    ...
    public readonly unsafe struct IPtoStateMap4 : IEnumerable<IPtoStateMapEntry4>
    {
        ...
        public Enumerator GetEnumerator() => new Enumerator(NumEntries, _pEntries, _functionAddress);
        ...
        public struct Enumerator : IEnumerator<IPtoStateMapEntry4>
        {
            ...
            internal Enumerator(int numEntries, byte* pEntries, int functionAddress)
            {
            ...
            public bool MoveNext()
            {
                ...
                {
                    Current = new IPtoStateMapEntry4(ref _pEntries, _functionAddress, _prevAmount);
