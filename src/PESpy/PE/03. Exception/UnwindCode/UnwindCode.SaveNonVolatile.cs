...
namespace PESpy
{
    public readonly unsafe partial struct UnwindCode
    {
        ...
        public readonly struct SaveNonVolatile : IViewable
        {
            ...
            public ushort StackOffset => *((ushort*) (value + 2));
            ...
            public SaveNonVolatile(byte* value)
            {
                this.value = value;
            }

            public static implicit operator byte*(SaveNonVolatile value) => value.value;
