...
namespace PESpy
{
    ...
    public struct MessageResourceBlock : IValue, IViewable
    {
        ...
        public RVA<MessageResourceEntry[]> OffsetToEntries
        {
            get
            {
                if (offsetToEntries.ListedOffset == 0)
                {
                    ...
                    using var list = new ValueList<MessageResourceEntry>();
        ...
        {
            writer.WriteRVAField(OffsetToEntries, Offset, OffsetToEntriesOffset);
        }

        IView? IViewable.WriteStruct(ViewWriter writer) =>
            writer.NewStruct(this, ViewKind.MessageResourceBlock, StructSize);
