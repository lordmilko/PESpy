    ...
    public readonly struct AddrHash32v12 : IAddrHashInternal32
    {
        ...
        private int StructSize
        {
            get
            {
                ...
                size += (cSeg * (sizeof(int) + sizeof(int))); //SegmentTable, OffsetCounts
        ...
        IView? IViewable.WriteStruct(ViewWriter writer) =>
            writer.NewStruct(this, ViewKind.AddrHash32v12, StructSize);
        ...
        void IViewable.WriteChild(int index, ref StructWriter structWriter)
        {
            switch (index)
            {
                ...
                case 4:
                    ...
                    structWriter.WriteField(nameof(OffsetTable), 4 + (SegmentTable.Length * (sizeof(int) + sizeof(int))), OffsetTable, offsetTableSize);
                    break;
