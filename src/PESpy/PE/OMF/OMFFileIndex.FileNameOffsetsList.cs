...
namespace PESpy
{
    ...
    {
        private OMFFileIndex.FileNameOffsetsList list;

        public FileNameOffsetsListDebugView(OMFFileIndex.FileNameOffsetsList list)
        {
            this.list = list;
        }
    ...
    public partial class OMFFileIndex
    {
        ...
        public readonly struct FileNameOffsetsList : IEnumerable<NativeSpan<int>>
        {
            ...
            internal FileNameOffsetsList(OMFFileIndex info)
            {
                this.info = info;
                baseOffset = default;
            ...
            public struct Enumerator : IEnumerator<NativeSpan<int>>
            {
                ...
                public Enumerator(OMFFileIndex info, int baseOffset)
                {
