namespace PESpy.Ecma335
{
    public static class MetadataExtensions
    {
        ...
        internal static CustomAttributeRow GetCustomAttributeHandle(this ModelHeap heap, CustomAttributeList customAttributes, string customAttributeNamespace, string customAttributeName)
        {
        ...
        internal static bool IsEqualCustomAttributeName(ModelHeap heap, in CustomAttributeRow customAttribute, string customAttributeNamespace, string customAttributeName)
        {
