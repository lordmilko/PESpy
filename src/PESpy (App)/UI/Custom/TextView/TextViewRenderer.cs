...
namespace PESpy.UI
{
    public class TextViewRenderer : ISymbolResolver, IDisposable
    {
        ...
        public TextViewRenderer(IGraphics graphics, FileAccessor fileAccessor, int width, int height)
        {
        ...
        private void RepaintExistingLines(HDC hdc)
        {
            ...
            _graphics.CommitMemDC(0, 0, _width, _height, 0, 0, hdc);
        }
        ...
        public void ScrollLinesDown(int numLinesToScroll)
            ...
            var yPos = ShiftPixelsUp(numLinesRemaining) + _yTop;
        ...
        private int ShiftPixelsUp(int numLinesToScroll)
        {
            ...
            var yPos = (_hBitmapHeight - scrollAmount) + _yTop;
            ...
            var yPos = ShiftPixelsDown(numLinesToScroll) + _yTop;
        ...
        internal unsafe void UpdateScrollBar()
        {
            ...
            if (_lines.Count > 0)
            {
                ...
                //How many bytes fit on the screen?
                pageSize = lastLine.EndAddress - firstLine.StartAddress;
            }
            else
        ...
        public void Resize(int width, int height)
        {
            ...
            if (newBitmapHeight == _hBitmapHeight && width == _hBitmapWidth)
                ...
                case OpKind.Memory:
                    switch (instruction.MemoryBase)
                    {
                        ...
                        case Register.None:
                            ...
                            {
                                Debug.Assert(_fileAccessor is PEFileAccessor); //todo: dont know if we need to subtract the imagebase in other file types too?
