...
namespace PESpy.UI
{
    public class Win32Graphics : IGraphics
    {
        ...
        private HBRUSH _hWhiteBrush; //Stock object, doesn't need disposing
        ...
        public unsafe void Initialize()
        {
            ...
            var dpi = Gdi32.GetDeviceCaps(hdc, GET_DEVICE_CAPS_INDEX.LOGPIXELSX);
            var lf = new LOGFONTW
            {
                lfHeight = -((int) (10.5 * dpi / 72)),
            };
