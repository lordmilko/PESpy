...
```
cl /c /Zi main.cpp
link /DEBUG /pdb:none main.obj /out:TestApp.exe
```
...
You don't get a PDB when you do this, but you can rebuild again without /pdb:none to get a VC50 style PDB with MODI50 entries